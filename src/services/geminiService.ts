...
export const getCropRecommendations = async (details: {
    ...
    const prompt = `
        ...
        Provide "perfect" crop recommendations based on the user's specific farm details.
        ...
        CRITICAL: Calculate financial data realistically for ${farmSize} acres.
        "Live Market Prices": Use your comprehensive knowledge to estimate current market prices in ${location} region.
        
        Return a JSON array with objects containing:
        - cropName: string
        - profitability: "High Profit" | "Medium Profit" | "Low Profit"
        - expectedYield: string (e.g. "X-Y quintals/acre", specific to ${farmSize} acres total if possible or per acre)
        ...
        - reasons: string[] (3 distinct reasons)

        Ensure "estimatedProfit" is: (Yield * Market Price) - Investment.
        Make the data precise and realistic.
    `;
