...
class OpenMeteoService:
    ...
    async def get_farming_context(self, city: str):
        """Fetches soil moisture, soil temperature, and weather."""
            ...
            async with httpx.AsyncClient() as client:
                response = await client.get(
                    ...
                    params={
                        "latitude": lat,
                        "longitude": lon,
                        "current": "temperature_2m,relative_humidity_2m,rain,soil_temperature_0cm,soil_moisture_0_to_7cm",
                        "timezone": "auto"
                    }
                )
                response.raise_for_status()
